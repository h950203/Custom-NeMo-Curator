...
INPUT_PATH = "data/"
OUTPUT_PATH = "filtered_data_v2.5/"
REMOVED_LOGS_PATH = "filtered_data_v2.5/log/"
...
def create_summary(logs_dir):
    ...
    with open(summary_file, 'w', encoding='utf-8') as f:
        ...
        all_stages = ['preprocessing_empty', 'preprocessing_error', 'word_count', 
                     ...
                     'mean_word_length', 'symbols', 'urls', 'quality_score']
...
def main():
    ...
    try:
        ...
        for input_file in sorted(input_files):
            process_file_with_tracking(input_file, OUTPUT_PATH, FILTER_CONFIG)
