...
from nemo_curator.stages.text.preprocessing.first_preprocess import preprocess_text
...
INPUT_PATH = "data/"
OUTPUT_PATH = "filtered_data_v1.2/"
REMOVED_LOGS_PATH = "filtered_data_v1.2_log/"
...
def process_file_with_tracking(input_file, output_dir, config):
    ...
    try:
        ...
        pipeline.add_stage(PreAnalyzeFilterStage (
